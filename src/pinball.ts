...
// (() => {
//     // plugins
//     Matter.use(MatterAttractors as any);
...
//     // score elements
//     const $currentScore = $('.current-score span');
//     const $highScore = $('.high-score span');
...
// /**
//  * It does sound like a CCD issue, for something like this
//  * I would highly suggest using a lower delta and multiple
//  * Engine.update per step (e.g. call 3 times per frame using
//  * a delta of (1/3)/60 * 1000ms). Also you should make your
//  * flippers as thick as possible but render them as if they
//  * were thin, using collision filters so they don't jam against walls.

// There's actually an awesome pinball example by @lonekorean you should
// check out and he also wrote a great post about it which includes how
// he solved the issue you're having for now until CCD is sorted.
//  */